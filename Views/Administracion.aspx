...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView runat="server" DataKeyNames="Id" ID="dgvArticulos" AutoGenerateColumns="false" CssClass="table my-3">
        <Columns>
    ...
    <a href="Alta.aspx" class="btn btn-primary">Agregar artículo</a>
</asp:Content>
